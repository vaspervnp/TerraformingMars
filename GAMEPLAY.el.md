...
- **Πού μένουν τα saves** — στον φάκελο του λογαριασμού σου, ώστε να επιβιώνουν από rebuild ή επανεγκατάσταση: `%APPDATA%\Terraforming Mars\SavedGames` σε Windows, `~/.local/share/TerraformingMars/SavedGames` σε Linux (τηρείται το `$XDG_DATA_HOME`), `~/Library/Application Support/Terraforming Mars/SavedGames` σε macOS. Η ακριβής διαδρομή γράφεται στο κάτω μέρος της οθόνης «Load Game». Όσα save έχουν μείνει δίπλα σε παλιότερο build μεταφέρονται εκεί αυτόματα στο ξεκίνημα.
