...
| Αναθέσεις πληρώματος | όλο το πλήρωμα σε μία οθόνη — **drag & drop** αποίκων ανάμεσα στα κτήρια (**C**) |
| Προσωπικό · Κοίτασμα | μετρητές κτιρίων που χρειάζονται εργάτες / έχουν εξαντληθεί — κλικ = πήγαινε στο επόμενο |
| Κλειδί | πήγαινε στο επόμενο **χαλασμένο** κτήριο (**/**) — τα χαλασμένα έχουν και κόκκινο κλειδί πάνω τους στον χάρτη |
...
| **C** | οθόνη αναθέσεων: σέρνεις έναν άποικο σε θέση κτηρίου — αν η θέση είναι πιασμένη οι δύο ανταλλάσσουν κτήριο, drop στο *UNASSIGNED* τον αποδεσμεύει |
